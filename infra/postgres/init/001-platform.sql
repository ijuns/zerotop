-- Local Compose bootstrap. Deployed environments must use the versioned API
-- migration runner and a dedicated Keycloak database/schema owner.
...
CREATE TABLE organization_memberships (
  -- A primary key on user_id is the database-level one-organization invariant.
...
-- Keep this in sync with services/api/migrations/001_initial.sql. Marking the
-- version applied prevents the API migration runner from recreating these tables.
